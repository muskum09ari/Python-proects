...
if __name__ == "__main__":
	...
	button5 = Button(gui, text=' 5 ', fg='black', bg='green',command=lambda: press(5), height=1, width=7)
	...
	button0 = Button(gui, text=' 0 ', fg='black', bg='gray',command=lambda: press(0), height=1, width=7)
	...
	divide = Button(gui, text=' / ', fg='black', bg='violet',command=lambda: press("/"), height=1, width=7)
	divide.grid(row=5, column=3)

	equal = Button(gui, text=' = ', fg='black', bg='red',command=equalpress, height=1, width=7)
	equal.grid(row=5, column=2)

	clear = Button(gui, text='Clear', fg='black', bg='pink',command=clear, height=1, width=7)
